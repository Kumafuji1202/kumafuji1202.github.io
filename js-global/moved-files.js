var movedFiles = [
    // ディレクトリ全体を指定するときは最後に/を含めない
    {
        "name": {
            "en": "Rolling Sky Spritesheet Maker",
            "en-Shaw": "·𐑮𐑴𐑤𐑦𐑙 𐑕𐑒𐑲 𐑕𐑐𐑮𐑲𐑑𐑖𐑰𐑑 𐑡𐑧𐑯𐑼𐑱𐑑𐑼",
            "ja": "ローリングスカイテクスチャメーカー",
        },
        "from": "/rolling-sky-spritesheet-maker",
        "to": "/rolling-sky/tools/spritesheet-generator"
    },
    {
        "name": {
    ...
    },
    {
        ...
        "from": "/arabic-to-presentation",
        "to": "/linguistics/arabic-to-presentation"
    },
    {
        "name": {
            "en": "Foo",
